'''
Priority Algorithm (Preemptive) in Python
PID:- Process ID
AT:- Arrival Time
WT:- Waiting time
CT:- Complition Time
...
class Priority:
    ...
    def processData(self, no_of_processes):
        ...
        for i in range(no_of_processes):
            ...
            arrival_time = int(input(f"Enter AT of process {process_id} : "))
            burst_time = int(input(f"Enter BT of Process {process_id} : "))
    ...
    def calculateTurnaroundTime(self, process_data):
        ...
        '''
        Average TAT = TAT/ Number of Process(n)
        '''
    ...
    def calculateWaitingTime(self, process_data):
        ...
        '''
        Average WT = WT/ Number of Process(n)
        '''
...
if __name__ == "__main__":
    no_of_processes = int(input("Enter Number of Process : "))
    priority = Priority()
